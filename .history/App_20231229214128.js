...
const App = () => {
  ...
  const [isfirsttime, setIsFirstTime] = useState('Sign')
  ...
  const Logging = async () => {
    var value = await AsyncStorage.getItem('isfirsttime')
  if (value) {
    setIsFirstTime('Home')
    value == false
    await AsyncStorage.setItem('isfirsttime', 'Home')
  }
  }

  return  <NavigationContainer>
       <stack.Navigator initialRouteName={isfirsttime}>
