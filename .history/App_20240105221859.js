...
const App = () => {
  ...
  return  <NavigationContainer>
       ...
       <stack.Screen name="Sign" component={Sign_Up} options={{title: 'Study_Pal-Sign_Up'}} />
       <stack.Screen name = "Home" component={Home} options={{title: 'Study_Pal-Home'}}/>
       <stack.Screen name="software" component={Softwareeng} options={{title: 'Study_Pal Software'}}/>
