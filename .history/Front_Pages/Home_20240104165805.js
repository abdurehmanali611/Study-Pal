    ...
    <View style = {styles.header_images}>
        ...
        {profiles ? (
          ...
          <View style = {[styles.profileelement, isenabled && styles.nightmode]}>
            ...
            />
            </TouchableOpacity>/* `profilephoto` is a function that is being called when the
            user presses on the camera image in the profile section.
            However, the implementation of the `profilephoto` function is
            not provided in the code snippet, so it is not possible to
