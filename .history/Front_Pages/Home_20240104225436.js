...
import { parname, parlast } from '../Pushed_Pages/Profile_create'
    ...
    <View style = {styles.header_images}>
        ...
        {profiles ? (
          ...
          <View style = {[styles.profileelement, isenabled && styles.nightmode]}>
            ...
            <View>
              <Text>{AsyncStorage.getItem(JSON.parse(parname))}</Text>
              <Text>{AsyncStorage.getItem(JSON.parse(parlast))}</Text>
            </View>
            <View>
              <View>
                <TouchableOpacity
