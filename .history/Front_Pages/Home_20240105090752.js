...
import { nametitle, lasttitle } from '../Pushed_Pages/Profile_create'
    ...
    <View style = {styles.header_images}>
        ...
        {profiles ? (
          ...
          <View style = {[styles.profileelement, isenabled && styles.nightmode]}>
            ...
            <View>
              <Text>{AsyncStorage.getItem(JSON.parse(nametitle))} {AsyncStorage.getItem(JSON.parse(lasttitle))}</Text>
            </View>
            <View>
              <View>
                <TouchableOpacity
