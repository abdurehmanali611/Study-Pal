...
startAnimation = () => {
  ...
  <TouchableWithoutFeedback onPress={() => {
    ...
    <View style = {styles.header_images}>
      {menubtn ? (
            <TouchableOpacity 
            style = {{backgroundColor: randomRGB(), borderRadius: 20, width: 80, height: 80, alignItems: 'center', justifyContent: 'center'}}
            onPress={menupressed}>
              <Image 
        ...
        <TouchableOpacity 
        style = {{backgroundColor: randomRGB(), borderRadius: 20, width: 80, marginHorizontal: 10, height: 80, alignItems: 'center', justifyContent: 'center'}}
