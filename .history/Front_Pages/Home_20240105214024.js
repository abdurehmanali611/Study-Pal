        ...
        {profiles ? (
          ...
          <View style = {[styles.profileelement, isenabled && styles.nightmode]}>
            <View style = {{marginVertical: 30}}>
              <View>
                <TouchableOpacity 
                style = {{flexDirection: 'row', backgroundColor: randomRGB(), alignItems: 'center', justifyContent: 'center', height: 80, borderRadius: 20}}
                onPress={selectProfilePhoto}>
                  <Image 
                  source={require('../assets/camera.jpg')}
                  style = {styles.camera}
                  />
                  <Text style = {{ fontSize: 19, backgroundColor: randomRGB(), textAlignVertical: 'center', height: 60, width: 190, borderRadius: 30, textAlign: 'center',}}>Change Profile</Text>
                </TouchableOpacity>
              </View>
