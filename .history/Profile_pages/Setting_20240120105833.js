...
import { request, PERMISSIONS, R } from "react-native-permissions";
...
const Setting = () => {
  ...
  useEffect(() => {
    // Check the current status of location permission when the component mounts
  ...
  const handlePress = () => {
    // Trigger the location permission request when the button is pressed
    checkLocationPermission();
  };
