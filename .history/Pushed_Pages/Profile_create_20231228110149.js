...
const Profile_create = ({navigation}) => {
    ...
    const submitted = async () => {
      ...
      var name = await AsyncStorage.setItem('name')
      var lastname = await AsyncStorage.setItem('lastname')
      var email = await AsyncStorage.setItem('email')
      var password = await AsyncStorage.setItem('password')
      var university = await AsyncStorage.setItem('university')
      var bio = await AsyncStorage.setItem('lastname')
    }
