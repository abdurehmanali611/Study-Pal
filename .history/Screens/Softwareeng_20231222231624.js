...
const Softwareeng = ({navigation}) => {
    ...
    const savetitlecards = () => {
       const headers = AsyncStorage.setItem('titles', JSON.stringify(titleflashcardssof))
    }

    const savetextcards = () => {
       const sons = AsyncStorage.setItem('texts',JSON.stringify(textflashcardssof))
    }
    ...
    const saveflash = () => {
        ...
        titles = {titleflashcardssof}, 
        types = {textflashcardssof}
        )
    }
